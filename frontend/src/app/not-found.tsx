  ...
  return (
    ...
    >
      <div className="max-w-2xl bg-white p-10 sm:p-16 rounded-3xl shadow-sm border border-[#E5E5E5] flex flex-col items-center">
        ...
        <p className="text-[#6B6B6B] mb-8 text-lg max-w-lg leading-relaxed">
          While you're here, maybe take a second to learn about{" "}
          <a 
            href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-[#F15A24] font-semibold hover:underline outline-none focus-visible:ring-2 focus-visible:ring-[#F15A24] rounded-sm transition-all"
          ...
          <span className="mt-2 block text-sm">
            Like 404, which means the requested page couldn't be found!
          </span>
        </p>
